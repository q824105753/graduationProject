...
<div class="page-container">
    <!-- Page Sidebar -->
    <!-- /Page Sidebar -->
    <jsp:include page="/admin/pagesidebar.jsp"/>

    <!-- Page Content -->
    <div class="page-content">
        <jsp:include page="/admin/pageheader.jsp"/>
        <!-- Page Inner -->
                        ...
                        <div class="panel panel-white">
                            ...
                            <div class="panel-body">
                                <div class="task-list">
                                    ...
                                    <div class="task-item">
                                        <span class="task-name">Update NVD3 chart plugin<i
                        ...
                        <div class="panel panel-white">
                            ...
                            <div class="panel-body">
                                <div class="project-stats">
                                    <ul class="list-unstyled">
                                        <li>Alpha - Admin Template<span
                                                class="label label-default pull-right">85%</span></li>
                                        <li>Meteor - Landing Page<span
                                                class="label label-success pull-right">Finished</span></li>
                                        <li>Modern - Corporate Website<span class="label label-success pull-right">Finished</span>
                                        </li>
                                        <li>Space - Admin Template<span
                                                class="label label-danger pull-right">Rejected</span></li>
                                        ...
                                        <li>E-mail Templates<span class="label label-default pull-right">Pending</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<script src="/admin/base/category1.js"></script>
<script src="/admin/base/category2.js"></script>
<script src="/admin/base/order.js"></script>
<script src="/admin/base/user.js"></script>
<script src="/admin/base/car.js"></script>
<script src="/admin/base/car-del.js"></script>
</body>
</html>