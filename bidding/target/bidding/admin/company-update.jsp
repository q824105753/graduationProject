...
<div class="page-content">
	<div class="content">
		<!-- 右侧内容框架，更改从这里开始 -->
		<form class="layui-form form-control" action="/bidding/admin/updateCompany"
			method="post">
			<input type="hidden" id="companyid" name="companyid" value="${company.companyid }">
			<input type="hidden" id="addressid" name="addressid" value="${company.address.addressid }">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="companyname" name="companyname" required=""
							autocomplete="off" class="layui-input" value="${company.companyname }">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="addressname" name="addressname" required=""
							autocomplete="off" class="layui-input" value="${company.address.addressname }">
					</div>
					<div class="layui-form-mid layui-word-aux">
						<span class="x-red"></span>
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="tel" name="tel" required=""
							lay-verify="tel" autocomplete="off" class="layui-input" value="${company.tel }">
					</div>
				</div>
					...
					<div class="layui-input-inline">
						<select name="userid" id="userid" lay-filter="aihao">
							...
							<c:forEach items="${ulist }" var="u">
								<option value="${u.userid }" <c:if test="${company.userid==u.userid }">selected</c:if> >${u.name }</option>
							</c:forEach>
						</select>
					</div>
				</div>
