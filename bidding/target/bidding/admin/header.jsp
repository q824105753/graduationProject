...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="/bidding/admin/index">招标信息管理系统</a></div>
    ...
    <ul class="layui-nav right" lay-filter="">
        ...
        <li class="layui-nav-item"><a href="/bidding/login.jsp">前台登录</a></li>
    </ul>
</div>
    ...
    <div id="side-nav">
        <ul id="nav">
            ...
            <li class="list">
                ...
                <ul class="sub-menu">
                    <li>
                        <a href="/bidding/admin/selectAllUserByPage" rel="external nofollow">
                            <i class="iconfont">&#xe6a7;</i>
                            用户列表
                        </a>
                    </li>
                    <li>
                        <a href="/bidding/admin/selectByDel">
                            <i class="iconfont">&#xe6a7;</i>
                            用户删除
                        </a>
                    </li>
            ...
            <li class="list" >
                ...
                <ul class="sub-menu">
                    <li>
                        <a href="/bidding/admin/selectAllCompanyByPage">
                            <i class="iconfont">&#xe6a7;</i>
                            公司列表
                        </a>
                    </li>
            ...
            <li class="list" >
                ...
                <ul class="sub-menu" style="display:none">
                    <li>
                        <a href="/bidding/admin/selectAllNoticeByPage">
                            <i class="iconfont">&#xe6a7;</i>
                            招标公告列表
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="/bidding/admin/selectByNoticeDel">
                            <i class="iconfont">&#xe6a7;</i>
                            招标公告删除
                        </a>
                    </li>
            ...
            <li class="list" >
                ...
                <ul class="sub-menu" style="display:none">
                    <li>
                        <a href="/bidding/admin/selectAllTenderByPage">
                            <i class="iconfont">&#xe6a7;</i>
                            投标申请列表
                        </a>
                    </li>
                    <li>
                        <a href="/bidding/admin/toSoftDeleteTender">
                            <i class="iconfont">&#xe6a7;</i>
                            投标申请删除列表
                        </a>
                    </li>
            ...
            <li class="list" >
                ...
                <ul class="sub-menu" style="display:none">
                    <li>
                        <a href="/bidding/admin/echarts1.jsp">
                            <i class="iconfont">&#xe6a7;</i>
                            拆线图
                        </a>
                    </li>
                    <li>
                        <a href="/bidding/admin/echarts2.html">
                            <i class="iconfont">&#xe6a7;</i>
                            柱状图
                        </a>
                    </li>
                    <li>
                        <a href="/bidding/admin/echarts3.html">
                            <i class="iconfont">&#xe6a7;</i>
                            地图
                        </a>
                    </li>
                    <li>
                        <a href="/bidding/admin/echarts4.html">
                            <i class="iconfont">&#xe6a7;</i>
                            饼图
                        </a>
                    </li>
                    <li>
                        <a href="/bidding/admin/echarts5.html">
                            <i class="iconfont">&#xe6a7;</i>
                            k线图
                        </a>
                    </li>
                    <li>
                        <a href="/bidding/admin/echarts6.html">
                            <i class="iconfont">&#xe6a7;</i>
                            仪表图
                        </a>
                    </li>
