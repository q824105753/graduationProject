...
<%@include file="/admin/header.jsp"%>
        ...
        <div class="page-content">
          <div class="content" >
            <!-- 右侧内容框架，更改从这里开始 -->
            <form class="layui-form form-control" action="/bidding/admin/insertNotice" method="post">
            <div style="margin:auto 200px auto 250px">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="isissue" value="1" class="del" title="是" checked="">
                        <input type="radio" name="isissue" value="0" class="del" title="否">
                    </div>
                </div>
