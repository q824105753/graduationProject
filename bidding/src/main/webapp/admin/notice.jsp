...
<div class="page-content">
	<div class="content">
		<!-- 右侧内容框架，更改从这里开始 -->
		<form class="layui-form xbs" action="/bidding/admin/selectAllNoticeByPage">
			<div class="layui-form-pane" style="text-align: center;">
				<div class="layui-form-item" style="display: inline-block;">
					<label class="layui-form-label xbs768">查找</label>
					
					<div class="layui-input-inline">
						<input type="text" name="itemname" value="${itemname }" placeholder="请输入项目名称"
		...
		<button class="layui-btn"
			onclick="window.location.href='/bidding/admin/toNoticeAdd'">
			<i class="layui-icon">&#xe608;</i>添加
		</button>
		<span class="x-right" style="line-height: 40px">共有数据：${noticeCount } 条</span></xblock>
			...
			<tbody>
				<c:forEach items="${nlist.list }" var="n">
					<tr>
						...
						<td><a href="javascript:;" onclick="noticeDetail('招标公告详情','/bidding/admin/noticeDetail?noticeid='+${n.noticeid },'400','200')">${n.itemname } </a> </td>
						<td>${n.user.name }</td>
						...
						<td class="td-manage">
							...
							onclick="window.location.href='/bidding/admin/loadNotice?noticeid=${n.noticeid }'"
							...
							onclick="window.location.href='/bidding/admin/softDelNotice?noticeid=${n.noticeid }'" style="text-decoration: none">
								<i class="layui-icon">&#xe640;</i>
						</a>
						</td>
					</tr>
		...
		<div class="x-right">
		<c:forEach items="${nlist.pageView }" var="p">
			${p }
		</c:forEach>
		</div>
		<!-- 右侧内容框架，更改从这里结束 -->
...
<script>
	...
	/*用户-添加*/
	function noticeDetail(title, url, w, h) {
