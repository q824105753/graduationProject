...
<div class="page-content">
	<div class="content">
		<!-- 右侧内容框架，更改从这里开始 -->
		<form class="layui-form xbs" action="/bidding/bid/selectTender">
			...
			<tbody>
				...
				<tr>
					...
					<td class="td-manage">
						...
						onclick="window.location.href='/bidding/bid/loadTender?tenderid=${tender.tenderid}'"
						class="ml-5" style="text-decoration: none"> <i
							class="layui-icon">&#xe642;</i>
					</a> 
					<a title="删除" href="javascript:;"
							onclick="window.location.href='/bidding/bid/softDelTender?tenderid=${tender.tenderid}'" style="text-decoration: none">
								<i class="layui-icon">&#xe640;</i>
						</a>
					</td>
				</tr>
