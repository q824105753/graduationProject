...
<div class="page-content">
	<div class="content">
		<!-- 右侧内容框架，更改从这里开始 -->
		<form class="layui-form xbs" action="/bidding/bid/selectNotice">
		...
		<button class="layui-btn"
			onclick="window.location.href='/bidding/bid/toNoticeAdd'">
			...
			<tbody>
				<c:forEach items="${nlist.list }" var="n">
					<tr>
						...
						<td><a href="javascript:;" onclick="noticeDetail('招标公告详情','/bidding/bid/noticeDetail?noticeid='+${n.noticeid },'400','200')">${n.itemname } </a> </td>
						<td>${n.user.name }</td>
						...
						<td class="td-manage">
							...
							onclick="window.location.href='/bidding/bid/loadNotice?noticeid=${n.noticeid }'"
							...
							onclick="window.location.href='/bidding/bid/softDelNotice?noticeid=${n.noticeid }'" style="text-decoration: none">
								<i class="layui-icon">&#xe640;</i>
						</a>
						</td>
					</tr>
