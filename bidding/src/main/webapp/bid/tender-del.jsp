				...
				<tr>
					...
					<td><c:if test="${tender.state==0 }">未签约</c:if><c:if test="${tender.state==1 }">已签约</c:if></td>
						...
						<td class="td-manage"><a style="text-decoration: none"
							onclick="window.location.href='/bidding/bid/resetTender?tenderid=${tender.tenderid }'" href="javascript:;"
							title="恢复"> <i class="layui-icon">&#xe618;</i>
						</a> <a title="彻底删除" href="javascript:;"
							onclick="window.location.href='/bidding/bid/delTender?tenderid=${tender.tenderid }'" style="text-decoration: none">
								<i class="layui-icon">&#xe640;</i>
						</a></td>
