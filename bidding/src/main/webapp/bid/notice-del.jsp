				...
				<c:forEach items="${nlist }" var="n">
					<tr>
						...
						<td class="td-manage"><a style="text-decoration: none"
							onclick="window.location.href='/bidding/bid/resetNotice?noticeid=${n.noticeid }'" href="javascript:;"
							title="恢复"> <i class="layui-icon">&#xe618;</i>
						</a> <a title="彻底删除" href="javascript:;"
							onclick="window.location.href='/bidding/bid/delNotice?noticeid=${n.noticeid }'" style="text-decoration: none">
								<i class="layui-icon">&#xe640;</i>
						</a></td>
